...
\date{Version 2.0.2, \today, für TYPO3 CMS 6.2}

\title{
  Spickzettel zu testgetriebener Entwicklung mit PHPUnit (mit oder ohne TYPO3)
}
...
\begin{phpcode}
class _DataMapperTest extends \Tx_Phpunit_TestCase {
    /**
